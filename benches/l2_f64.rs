...
fn lak_dgemv_n(bencher: Bencher, n: usize) {
    let alpha = 0.1;
    let beta  = 0.1;
    ...
    let y_init: Vec<f64> = make_vec_random(n, rng);
...
#[divan::bench(args = MATRIX_SIZES)]
fn blas_dgemv_n(bencher: Bencher, n: usize) {
    let alpha = 0.1;
    let beta  = 0.1;
...
#[divan::bench(args = MATRIX_SIZES)]
fn lak_dgemv_t(bencher: Bencher, n: usize) {
    let alpha = 0.1;
    let beta  = 0.1;
...
#[divan::bench(args = MATRIX_SIZES)]
fn blas_dgemv_t(bencher: Bencher, n: usize) {
    let alpha = 0.1;
    let beta  = 0.1;
...
#[divan::bench(args = MATRIX_SIZES)]
fn blas_dger(bencher: Bencher, n: usize) {
    let alpha = 0.1;
    ...
    let a_init: Vec<f64> = make_vec_random(n * n, rng);
    let mut abuf = a_init.clone(); 

    bencher
        .counter(BytesCount::new(bytes_count_f64(2.0, 2, 2.0, n as f64) as u64))
...
#[divan::bench(args = MATRIX_SIZES)]
fn lak_dger(bencher: Bencher, n: usize) {
    let alpha = 0.1;
...
#[divan::bench(args = MATRIX_SIZES)]
fn lak_dtrmv_ln(bencher: Bencher, n: usize) {
    ...
    bencher
        .counter(BytesCount::new(bytes_count_f64(1.5, 2, 0.5, n as f64) as u64))
...
#[divan::bench(args = MATRIX_SIZES)]
fn blas_dtrmv_ln(bencher: Bencher, n: usize) {
    let rng = &mut bench_rng(2);
...
#[divan::bench(args = MATRIX_SIZES)]
fn lak_dtrmv_un(bencher: Bencher, n: usize) {
    let rng = &mut bench_rng(2);
...
#[divan::bench(args = MATRIX_SIZES)]
fn blas_dtrmv_un(bencher: Bencher, n: usize) {
    let rng = &mut bench_rng(2);
...
#[divan::bench(args = MATRIX_SIZES)]
fn lak_dtrmv_lt(bencher: Bencher, n: usize) {
    let rng = &mut bench_rng(2);
...
#[divan::bench(args = MATRIX_SIZES)]
fn blas_dtrmv_lt(bencher: Bencher, n: usize) {
    let rng = &mut bench_rng(2);
...
#[divan::bench(args = MATRIX_SIZES)]
fn lak_dtrmv_ut(bencher: Bencher, n: usize) {
    let rng = &mut bench_rng(2);
...
#[divan::bench(args = MATRIX_SIZES)]
fn blas_dtrmv_ut(bencher: Bencher, n: usize) {
    let rng = &mut bench_rng(2);

...
#[divan::bench(args = MATRIX_SIZES)]
fn lak_sgemm_tn(bencher: Bencher, n: usize) {
    let alpha = 0.1;
    let beta  = 0.0;
...
#[divan::bench(args = MATRIX_SIZES)]
fn blas_sgemm_tn(bencher: Bencher, n: usize) {
    let alpha = 0.1;
    let beta  = 0.0;
...
#[divan::bench(args = MATRIX_SIZES)]
fn faer_sgemm_tn(bencher: Bencher, n: usize) {
    let alpha = 0.1;
...
#[divan::bench(args = MATRIX_SIZES)]
fn lak_sgemm_tt(bencher: Bencher, n: usize) {
    let alpha = 0.1;
    let beta  = 0.0;
...
#[divan::bench(args = MATRIX_SIZES)]
fn blas_sgemm_tt(bencher: Bencher, n: usize) {
    let alpha = 0.1;
    let beta  = 0.0;
...
#[divan::bench(args = MATRIX_SIZES)]
fn faer_sgemm_tt(bencher: Bencher, n: usize) {
    let alpha = 0.1;

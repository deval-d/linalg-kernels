...
#[inline(always)]
pub(crate) fn sgemm_nn_blocked_micro(
...
#[inline(always)]
pub(crate) fn dgemm_nn_blocked_micro(
...
#[inline(always)]
pub(crate) fn sgemm_nn_blocked_tail(
    alpha: f32,
    a_panel: MatRef<'_, f32>,
    ...
    for j in j_beg..nc {
        ...
        for kk in 0..kc {
            ...
            let bval = b_slice[j * k + kc_beg + kk];
...
#[inline(always)]
pub(crate) fn dgemm_nn_blocked_tail(
    alpha: f64,
    a_panel: MatRef<'_, f64>,

...
#[inline(always)]
pub(crate) fn sgemm_tn_blocked_micro(
    packed_a: &[f32],
    packed_b: &[f32],
...
#[inline(always)]
pub(crate) fn dgemm_tn_blocked_micro(
    packed_a: &[f64],
    packed_b: &[f64],
...
#[inline(always)]
pub(crate) fn sgemm_tn_blocked_tail(
    packed_a: &[f32],
    alpha: f32,
...
#[inline(always)]
pub(crate) fn dgemm_tn_blocked_tail(
    packed_a: &[f64],
    alpha: f64,

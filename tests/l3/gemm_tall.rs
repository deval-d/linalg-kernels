...
fn dgemm_tn(case: u64) { 
    ...
    let a = MatRef::new(&abuf, (k, m));
    let b = MatRef::new(&bbuf, (k, n)); 
    let c = MatMut::new(&mut cbuf, (m, n)); 

    gemm(Transpose::Transpose, Transpose::NoTranspose, alpha, beta, a, b, c);
...
fn dgemm_tt(case: u64) { 
    ...
    gemm(Transpose::Transpose, Transpose::Transpose, alpha, beta, a, b, c);
